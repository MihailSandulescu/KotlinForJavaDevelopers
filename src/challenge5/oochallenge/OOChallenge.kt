package challenge5.oochallenge

fun main() {
//    val bicycle = KotlinBicycle(10, 3, 10)
//    bicycle.printDescription()
//    val mountainBike = KotlinMountainBike(20, 10, 30, 11)
...
//    val mountainBike2 = KotlinMountainBike(20, 10, 30)
//    mountainBike2.printDescription()
//    val roadBike2 = KotlinRoadBike(10, 10, 10)
//    roadBike2.printDescription()

    val mountainBike3 = KotlinMountainBike(color = "blue", cadence = 10, seatHeight = 10, speed = 10)
